...
<Image
     ...
     />
       ...
       <Text style={{fontSize:20,fontWeight:"500",marginLeft:5,marginBottom:10}}></Text>
...
<View style={{width:60,height:60,backgroundColor:Colors.lightblue,borderRadius:16,justifyContent:"center",alignItems:"center"}}>
<TouchableOpacity onPress={()=>navigation.navigate('shopping',{imagetype:'shopping'})}>
...
<Text style={{marginTop:10,fontSize:12,color:"white"}}>Products</Text>
</View>
    </TouchableOpacity>
...
<View style={{width:60,height:60,backgroundColor:Colors.lightblue,borderRadius:16,justifyContent:"center",alignItems:"center"}}>
<TouchableOpacity onPress={()=>navigation.navigate('BookAppointment',{imagetype:'appointment'})}>
...
<Text style={{marginTop:10,fontSize:12,color:"white",textAlign:"center"}}>Appointment</Text>
       ...
       <Text style={{fontSize:20,fontWeight:"500",marginLeft:5,marginTop:15,marginBottom:10}}></Text>
